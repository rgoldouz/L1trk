...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<int>     *tp_nstub;
   vector<int>     *tp_nstub_layer;
   vector<int>     *tp_nstub_layer_g;
   ...
   TBranch        *b_tp_nstub;   //!
   TBranch        *b_tp_nstub_layer;   //!
   TBranch        *b_tp_nstub_layer_g;   //!
...
//   virtual void     Loop();
   virtual void     SR(TString,TString);
   virtual void     TPR(TString,TString);
...
#ifdef stubRate_cxx
stubRate::stubRate(TTree *tree) : fChain(0) 
{
...
Int_t stubRate::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t stubRate::LoadTree(Long64_t entry)
{
...
void stubRate::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("tp_nstub_layer", &tp_nstub_layer, &b_tp_nstub_layer);
   fChain->SetBranchAddress("tp_nstub_layer_g", &tp_nstub_layer_g, &b_tp_nstub_layer_g);
...
void stubRate::Show(Long64_t entry)
{
...
Int_t stubRate::Cut(Long64_t entry)
{
