...
#ifndef stubRecoEff_h
#define stubRecoEff_h
...
//   virtual void     Loop();
   ...
   virtual void     eff2(TString,TString);
   virtual void     eff3(TString,TString);
...
#ifdef stubRecoEff_cxx
stubRecoEff::stubRecoEff(TTree *tree) : fChain(0) 
{
...
stubRecoEff::~stubRecoEff()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t stubRecoEff::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t stubRecoEff::LoadTree(Long64_t entry)
{
...
void stubRecoEff::Init(TTree *tree)
{
...
void stubRecoEff::Show(Long64_t entry)
{
...
Int_t stubRecoEff::Cut(Long64_t entry)
{
